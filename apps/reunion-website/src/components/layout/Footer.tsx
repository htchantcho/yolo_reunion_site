        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <a href="https://wa.me/237683031320" className="flex items-center gap-2 hover:text-white" target="_blank" rel="noopener noreferrer"><Phone size={14}/> +237 683 031 320</a>
            </div>
          </div>
        </div>

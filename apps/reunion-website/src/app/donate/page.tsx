      ...
      <div className="max-w-2xl mx-auto px-4">
        ...
        <div className="bg-white rounded-2xl border border-neutral-200 shadow-sm p-8 mb-6">
          ...
          <div className="rounded-xl p-5" style={{ background: '#F0F7F4', border: '1px solid #A8D5C2' }}>
            <p className="text-sm font-semibold mb-1" style={{ color: '#2D6A4F' }}>Contact us to arrange a contribution</p>
            <a
        ...
        <div className="text-center mt-8">
          ...
          <Link href="/register" className={buttonVariants({ variant: 'default' })} style={{ background: '#2D6A4F' }}>
